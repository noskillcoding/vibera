...
def docs_router(request, slug):
    ...
    docs_routes = {
        ...
        'rss-atom-feeds': rss_atom_feeds,
        'analytics': analytics_docs,
        'email-newsletters': email_newsletters,
        'anatomy-of-the-home-page': anatomy_home_page,
        'navigation': navigation,
        'styling': styling,
        'custom-project-lists': custom_project_lists,
        'comments-and-community': comments_and_community,
        'media-uploads': media_uploads,
        'github-integration': github_integration,
        'tags-and-tools': tags_and_tools,
        'neat-vibera-features': neat_vibera_features,
        'markdown-cheatsheet': markdown_cheatsheet,
        'date-format': date_format,
        'not-seeing-your-drop': not_seeing_your_drop,
